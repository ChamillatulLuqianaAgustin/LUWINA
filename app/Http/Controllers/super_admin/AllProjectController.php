...
class AllProjectController extends Controller
{
    private function getFirestore()
    {
        return new FirestoreClient([
            ...
            'transport' => 'rest', // 🔥 INI SOLUSI ERROR gRPC
        ]);
    }
    ...
    public function detailProcess($id)
    {
        ...
        return view('super_admin.allproject.process.detail_process', [
            'process' => [
                'id'               => $id,
                'nama_project'     => $data['ta_project_pekerjaan'],
                'deskripsi_project' => $data['ta_project_deskripsi'],
    ...
    public function editProcess($id)
    {
        ...
        return view('super_admin.allproject.process.edit_process', [
            'process' => [
                'id'               => $id,
                'nama_project'     => $data['ta_project_pekerjaan'],
                'deskripsi_project' => $data['ta_project_deskripsi'],
    ...
    public function updateProcess(Request $request, $id)
    {
        ...
        if (!$doc->exists()) {
            return redirect()->route('superadmin.allproject')->with('error', 'Project tidak ditemukan');
        }
        ...
        return redirect()
            ->route('superadmin.allproject_process_detail', $id)
    ...
    public function accProcess($id)
    {
        ...
        return redirect()->route('superadmin.allproject_process.acc')->with('success', 'Project berhasil di-ACC');
    }
    ...
    public function rejectProcess($id)
    {
        ...
        return redirect()->route('superadmin.allproject_process.reject')->with('success', 'Project berhasil di-Reject');
    }
    ...
    public function detailAcc($id)
    {
        ...
        // RETURN VIEW BLM DIGANTI
        return view('super_admin.allproject.acc.detail_acc', [
            'acc' => [
                'id'              => $id,
                'nama_project'    => $data['ta_project_pekerjaan'],
                'deskripsi_project' => $data['ta_project_deskripsi'],
    ...
    public function editAcc($id)
    {
        ...
        return view('super_admin.allproject.acc.edit_acc', [
            'acc' => [
                'id'               => $id,
                'nama_project'     => $data['ta_project_pekerjaan'],
                'deskripsi_project' => $data['ta_project_deskripsi'],
    ...
    public function updateAcc(Request $request, $id)
    {
        ...
        return redirect()
            ->route('superadmin.allproject_acc_detail', $id)
            ->with('success', 'Project berhasil diperbarui');
    }
    ...
    public function kerjakanAcc($id)
    {
        ...
        return redirect()->route('superadmin.allproject_acc_detail', $id)
    ...
    public function detailReject($id)
    {
        ...
        return view('super_admin.allproject.reject.detail_reject', [
            'reject' => [
                'id' => $id,
                'nama_project' => $data['ta_project_pekerjaan'],
                'deskripsi_project' => $data['ta_project_deskripsi'],
    ...
    public function editReject($id)
    {
        ...
        return view('super_admin.allproject.reject.edit_reject', [
            'reject' => [
                'id'               => $id,
                'nama_project'     => $data['ta_project_pekerjaan'],
                'deskripsi_project' => $data['ta_project_deskripsi'],
    ...
    public function updateReject(Request $request, $id)
    {
        ...
        return redirect()
            ->route('superadmin.allproject_reject_detail', $id)
            ->with('success', 'Project berhasil diperbarui');
    }
