...
class ProcessController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('mitra.process.process_mitra', compact('process_doc', 'grandTotal'));
    }
    ...
    public function detail($id)
    {
        ...
        if (!$doc->exists()) {
            return redirect()->route('mitra.process')->with('error', 'Data project tidak ditemukan');
        }
        ...
        return view('mitra.process.detail_process', [
            'process' => [
                'id'               => $id,
                'nama_project'     => $data['ta_project_pekerjaan'],
                'deskripsi_project' => $data['ta_project_deskripsi'],
    ...
    public function edit($id)
    {
        ...
        return view('mitra.process.edit_process', [
            'process' => [
                'id'               => $id,
                'nama_project'     => $data['ta_project_pekerjaan'],
                'deskripsi_project' => $data['ta_project_deskripsi'],
            ...
            'totals'         => $totals,
            'project_ta_doc' => $project_mitra_doc,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$doc->exists()) {
            return redirect()->route('mitra.process')->with('error', 'Project tidak ditemukan');
        }
    ...
    public function acc($id)
    {
        ...
        return redirect()->route('mitra.acc')->with('success', 'Project berhasil di-ACC');
    }
    ...
    public function reject($id)
    {
        ...
        return redirect()->route('mitra.reject')->with('success', 'Project berhasil di-Reject');
    }
