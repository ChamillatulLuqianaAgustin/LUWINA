...
class RejectController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('mitra.reject.reject_mitra', compact('reject_doc', 'grandTotal', 'qe_doc'));
    }
    ...
    public function detail($id)
    {
        ...
        if (!$doc->exists()) {
            return redirect()->route('mitra.reject')->with('error', 'Data project tidak ditemukan');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$doc->exists()) {
            return redirect()->route('mitra.reject')->with('error', 'Project tidak ditemukan');
        }
