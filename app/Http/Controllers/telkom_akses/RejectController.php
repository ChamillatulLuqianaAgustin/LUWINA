...
class RejectController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('telkom_akses.reject.edit_reject', [
            'reject' => [
                'id'               => $id,
                'nama_project'     => $data['ta_project_pekerjaan'],
                'deskripsi_project' => $data['ta_project_deskripsi'],
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$doc->exists()) {
            return redirect()->route('telkomakses.reject')->with('error', 'Project tidak ditemukan');
        }
        ...
        return redirect()
            ->route('telkomakses.reject_detail', $id)
