...
class AccController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('telkom_akses.acc.edit_acc', [
            'acc' => [
                'id'               => $id,
                'nama_project'     => $data['ta_project_pekerjaan'],
                'deskripsi_project' => $data['ta_project_deskripsi'],
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$doc->exists()) {
            return redirect()->route('telkomakses.acc')->with('error', 'Project tidak ditemukan');
        }
    ...
    public function kerjakan($id)
    {
        ...
        $doc = $docRef->snapshot();
        if (!$doc->exists()) {
            return redirect()->route('telkomakses.acc')
        ...
        return redirect()->route('telkomakses.acc_detail', $id)
