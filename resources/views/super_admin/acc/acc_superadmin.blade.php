...
<div class="page">
    ...
    <div class="table-responsive">
        <table class="data-table table-bordered table-striped table-hover table-sm" id="acc-table" style="min-width: 100%">
            ...
            <tbody>
                @forelse($accProjects as $index => $project)
                    <tr>
                        <td>{{ $index + 1 }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="10">Belum ada project ACC</td>
                    </tr>
                @endforelse
            </tbody>
            <tfoot>
