...
<div class="page">
    ...
    <div class="table-responsive">
        <table class="data-table table-bordered table-striped table-hover table-sm" id="process-table" style="min-width: 100%">
            ...
            <tbody>
                @forelse($processProjects as $index => $project)
                    <tr>
                        <td>{{ $index + 1 }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="10">Belum ada project PROCESS</td>
                    </tr>
                @endforelse
            </tbody>
            <tfoot>
