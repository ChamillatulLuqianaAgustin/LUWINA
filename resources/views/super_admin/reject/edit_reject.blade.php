...
@section('content')
    ...
    <div class="page">
        ...
        <div class="action-bar">
            <a href="{{ route('superadmin.reject_detail', $reject['id']) }}" class="btn-back">
                <i class="fa fa-arrow-left" style="margin-right: 8px;"></i> Back
            </a>
        </div>

        <!-- Form Edit -->
        <form action="{{ route('superadmin.reject_update', $reject['id']) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="table-wrapper">
                ...
                <div class="project-header">
                    <input type="text" name="nama_project" class="input-edit-project"
                        value="{{ old('nama_project', $reject['nama_project']) }}" required>
