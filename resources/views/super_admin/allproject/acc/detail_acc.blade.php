...
@section('content')
    ...
    <div class="page">
        ...
        <div class="action-bar">
            ...
            <div class="action-buttons">
                @if ($acc['tgl_pengerjaan'] == '-' || empty($acc['tgl_pengerjaan']))
                    <form id="formKerjakan" action="{{ route('superadmin.allproject.acc.kerjakan', $acc['id']) }}"
        ...
        <div class="table-wrapper">
            ...
            <div class="project-header">
                ...
                <a href="{{ route('superadmin.allproject_acc_edit', $acc['id']) }}" class="edit-project">Edit Project</a>
            </div>
                    ...
                    <tbody>
                        @foreach ($acc['detail'] ?? [] as $index => $item)
                            <tr>
                                ...
                                <td>
                                    <form
                                        action="{{ route('superadmin.allproject_acc_destroy', ['id' => $acc['id'], 'detailId' => $item->id]) }}"
        ...
        <div id="deleteProject" style="margin-top: 20px; text-align: left;">
            <form action="{{ route('superadmin.allproject_acc_destroy_project', $acc['id']) }}" method="POST"
    ...
    <div id="doneModal" class="modal" style="display:none;">
        <div class="modal-content">
            ...
            <form id="formUploadFoto" method="POST"
                action="{{ route('superadmin.allproject.acc.storeFoto', $acc['id']) }}" enctype="multipart/form-data">
                @csrf
    ...
    <div id="pendingModal" class="modal" style="display:none;">
        <div class="modal-content">
            ...
            <form action="{{ route('superadmin.allproject.acc.pending', $acc['id']) }}" method="POST">
                @csrf
