    ...
    <div class="page">
        ...
        <div class="action-bar">
            ...
            <div class="action-buttons">
                <form id="formAcc" action="{{ route('superadmin.allproject_process.acc', $process['id']) }}"
                ...
                <!-- Reject -->
                <form id="formReject" action="{{ route('superadmin.allproject_process.reject', $process['id']) }}"
                    method="POST" style="display:inline;">
                    @csrf
        ...
        <div class="table-wrapper">
            ...
            <div class="project-header">
                ...
                <a href="{{ route('superadmin.allproject_process_edit', $process['id']) }}" class="edit-project">Edit
                    Project</a>
            </div>
                    ...
                    <tbody>
                        @foreach ($process['detail'] ?? [] as $index => $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    <form
                                        action="{{ route('superadmin.allproject_process_destroy', ['id' => $process['id'], 'detailId' => $item->id]) }}"
        ...
        <div id="deleteProject" style="margin-top: 20px; text-align: left;">
            <form action="{{ route('superadmin.allproject_process_destroy_project', $process['id']) }}" method="POST"
