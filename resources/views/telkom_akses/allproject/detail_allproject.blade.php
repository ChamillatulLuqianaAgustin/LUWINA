    ...
    <div class="page">
        ...
        <div class="table-wrapper">
            ...
            <div class="project-header">
                ...
                <a href="{{ route('telkomakses.allproject_edit', $allproject['id']) }}" class="edit-project">Edit Project</a>
            </div>
                    ...
                    <tbody>
                        @foreach ($allproject['detail'] ?? [] as $index => $item)
                            <tr>
                                ...
                                <td>
                                    <form
                                        action="{{ route('telkomakses.allproject_destroy', ['id' => $allproject['id'], 'detailId' => $item->id]) }}"
        ...
        <div id="deleteProject" style="margin-top: 20px; text-align: left;">
            <form action="{{ route('telkomakses.allproject_destroy_project', $allproject['id']) }}" method="POST"
                    ...
                    if (result.isConfirmed) {
                        ...
                        try {
                            ...
                            Swal.fire({
                                ...
                                window.location.href = "{{ route('telkomakses.allproject') }}";
                            });
