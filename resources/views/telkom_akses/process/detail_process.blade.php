...
@section('content')
    ...
    <div class="page">
        ...
        <div class="action-bar">
            <!-- Tombol Back -->
            <a href="{{ route('telkomakses.process') }}" class="btn-back">
                <i class="fa fa-arrow-left" style="margin-right: 8px;"></i> Back
            </a>

            <!-- Tombol ACC / Reject -->
            <div class="action-buttons">
                <form id="formAcc" action="{{ route('telkomakses.process.acc', $process['id']) }}" method="POST"
                ...
                <!-- Reject -->
                <form id="formReject" action="{{ route('telkomakses.process.reject', $process['id']) }}" method="POST"
                    style="display:inline;">
                    @csrf
