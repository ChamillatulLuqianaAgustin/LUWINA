    ...
    @section('content')
        ...
        <div class="page">
            ...
            <div class="action-bar">
                ...
                <div class="action-buttons">
                    @if ($acc['tgl_pengerjaan'] == '-' || empty($acc['tgl_pengerjaan']))
                        <form id="formKerjakan" action="{{ route('telkomakses.acc.kerjakan', $acc['id']) }}" method="POST"
            ...
            <div class="table-wrapper">
                ...
                <div class="project-header">
                    ...
                    <a href="{{ route('telkomakses.acc_edit', $acc['id']) }}" class="edit-project">Edit Project</a>
                </div>
                        ...
                        <tbody>
                            @foreach ($acc['detail'] ?? [] as $index => $item)
                                <tr>
                                    ...
                                    <td>
                                        <form
                                            action="{{ route('telkomakses.acc_destroy', ['id' => $acc['id'], 'detailId' => $item->id]) }}"
            ...
            <div id="deleteProject" style="margin-top: 20px; text-align: left;">
                <form action="{{ route('telkomakses.acc_destroy_project', $acc['id']) }}" method="POST"
        ...
        <div id="doneModal" class="modal" style="display:none;">
            <div class="modal-content">
                ...
                <form id="formUploadFoto" method="POST" action="{{ route('telkomakses.acc.storeFoto', $acc['id']) }}"
        ...
        <div id="pendingModal" class="modal" style="display:none;">
            <div class="modal-content">
                ...
                <form action="{{ route('telkomakses.acc.pending', $acc['id']) }}" method="POST">
                    @csrf
