...
@section('content')
    ...
    <div class="page">
        ...
        <div class="action-bar">
            <!-- Tombol Back -->
            <a href="{{ route('mitra.reject') }}" class="btn-back">
        ...
        <div class="table-wrapper">
            ...
            <div class="project-header">
                ...
                <a href="{{ route('mitra.reject_edit', $reject['id']) }}" class="edit-project disabled">Edit
                    Project</a>
            </div>
        ...
        <div id="addRevisiModal" class="modal" style="display: none;">
            <div class="modal-content">
                ...
                <form class="addRevisiForm" id="addRevisiForm"
                    action="{{ route('mitra.reject_upload_revisi', $reject['id']) }}" method="POST"
        ...
        <div id="deleteProject" style="margin-top: 20px; text-align: left;">
            <form action="{{ route('mitra.reject_destroy_project', $reject['id']) }}" method="POST"
