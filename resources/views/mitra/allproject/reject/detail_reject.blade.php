    ...
    <div class="page">
        ...
        <div class="table-wrapper">
            ...
            <div class="project-header">
                ...
                <a href="{{ route('mitra.allproject_reject_edit', $reject['id']) }}" class="edit-project disabled">Edit
                    Project</a>
            </div>
                    ...
                    <tbody>
                        @foreach ($reject['detail'] ?? [] as $index => $item)
                            <tr>
                                ...
                                <td>
                                    <form
                                        action="{{ route('mitra.allproject_reject_destroy', ['id' => $reject['id'], 'detailId' => $item->id]) }}"
        ...
        <div id="addRevisiModal" class="modal" style="display: none;">
            <div class="modal-content">
                ...
                <form class="addRevisiForm" id="addRevisiForm"
                    action="{{ route('mitra.allproject_reject_upload_revisi', $reject['id']) }}" method="POST"
        ...
        <div id="deleteProject" style="margin-top: 20px; text-align: left;">
            <form action="{{ route('mitra.allproject_reject_destroy_project', $reject['id']) }}" method="POST"
